...
namespace UnityStandardAssets.Vehicles.Motobike
{
    ...
    public class motorbike_controller : MonoBehaviour
    {
        ...
        //Balancing of motobike
        //balance angle is euler angle between objects transform (transform.up) and global normal (Vector3.up)
        ...
        void FixedUpdate()
        {
            ...
            //Debug.Log(Mathf.Abs(m_SteerAngle));


            if (Mathf.Abs(m_SteerAngle) > Mathf.Abs(BalanceAngle))
            {
                float speed = m_Rigidbody.velocity.magnitude;
                m_Rigidbody.AddTorque(-transform.forward * 30 * m_SteerAngle);
            }
            ...
            if (Mathf.Abs(BalanceAngle) < 1 && Mathf.Abs(m_SteerAngle) < 20)
            {
